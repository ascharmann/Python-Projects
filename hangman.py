...
while True:
    ...
    if gameStart == "play":
        print("")
        wordList = ['python', 'java', 'coding', 'javascript', 'cyber', 'computer', 'science', 'programming',
                    'networks', 'mathematics', 'router', 'algorithm',
                    'subnet', 'keyboard', 'internet', 'software']
        ...
        lives = 8
        while lives > 0:
            word = input("Input a lowercase letter in parenthesis:  ")
